*
*     This is a version of DHGEQZ modified to use different deflation
*     criteria
*
      SUBROUTINE DHGEQZV1( JOB, COMPQ, COMPZ, N, ILO, IHI, H, LDH, T,
     $                   LDT, ALPHAR, ALPHAI, BETA, Q, LDQ, Z, LDZ,
     $                   WORK, LWORK, INFO, HDEFLATION, TDEFLATION,
     $                   NIITER )
      IMPLICIT NONE
*
